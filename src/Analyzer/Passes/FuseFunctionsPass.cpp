...
QueryTreeNodePtr createResolvedFunction(ContextPtr context, const String & name, QueryTreeNodes arguments)
{
...
QueryTreeNodePtr createTupleElementFunction(ContextPtr context, QueryTreeNodePtr argument, UInt64 index)
{
    return createResolvedFunction(context, "tupleElement", {argument, std::make_shared<ConstantNode>(index)});
}

QueryTreeNodePtr createArrayElementFunction(ContextPtr context, QueryTreeNodePtr argument, UInt64 index)
{
